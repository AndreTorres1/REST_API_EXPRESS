...
// const file = require('netflix_titles.csv')
// const app = express();
...
// client.connect();
//
// app.post('/insertCSV/', topojson().fromFile(file).then(source =>{
//     for(let i = 0; i < source.length; i++) {
//         show_id = source[i]["show_id"],
//             type = source[i]["type"],
...
//
//
//         const insertStatement = "INSERT INTO movies values (?,?,?,?,?,?,?,?,?,?,?,?)";
//         const items = [show_id, type, title, director, cast, country, data_added, release_year, rating, duration, listed_in, description]
//
// // Inserting data of current row into database
//         client.query(insertStatement, items,
//             (err) => {
//                 if (err) {
